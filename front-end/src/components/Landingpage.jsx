...
function Landingpage() {
  return (
      <>
        ...
        <iframe className="absolute  bg-[#fdfddb] top-[10%] bottom-[0%] right-2 " src='https://my.spline.design/untitled-549406a934ddba187e22c14e8d85202c/' frameborder='0' width='40%' height='800px'></iframe>
